...
def get_alpha(df):
        stock=Alphas(df)
        df['alpha1_001']=stock.alpha001() 
        df['alpha1_002']=stock.alpha002()
        df['alpha1_003']=stock.alpha003()
        df['alpha1_004']=stock.alpha004()
        df['alpha1_005']=stock.alpha005()
        df['alpha1_006']=stock.alpha006()
        df['alpha1_007']=stock.alpha007()
        df['alpha1_008']=stock.alpha008()
        df['alpha1_009']=stock.alpha009()
        df['alpha1_010']=stock.alpha010()
        df['alpha1_011']=stock.alpha011()
        df['alpha1_012']=stock.alpha012()
        df['alpha1_013']=stock.alpha013()
        df['alpha1_014']=stock.alpha014()
        df['alpha1_015']=stock.alpha015()
        df['alpha1_016']=stock.alpha016()
        df['alpha1_017']=stock.alpha017()
        df['alpha1_018']=stock.alpha018()
        df['alpha1_019']=stock.alpha019()
        df['alpha1_020']=stock.alpha020()
        df['alpha1_021']=stock.alpha021()
        df['alpha1_022']=stock.alpha022()
        df['alpha1_023']=stock.alpha023()
        df['alpha1_024']=stock.alpha024()
        df['alpha1_025']=stock.alpha025()
        df['alpha1_026']=stock.alpha026()
        df['alpha1_027']=stock.alpha027()
        df['alpha1_028']=stock.alpha028()
        df['alpha1_029']=stock.alpha029()
        df['alpha1_030']=stock.alpha030()
        df['alpha1_031']=stock.alpha031()
        df['alpha1_032']=stock.alpha032()
        df['alpha1_033']=stock.alpha033()
        df['alpha1_034']=stock.alpha034()
        df['alpha1_035']=stock.alpha035()
        df['alpha1_036']=stock.alpha036()
        df['alpha1_037']=stock.alpha037()
        df['alpha1_038']=stock.alpha038()
        df['alpha1_039']=stock.alpha039()
        df['alpha1_040']=stock.alpha040()
        df['alpha1_041']=stock.alpha041()
        df['alpha1_042']=stock.alpha042()
        df['alpha1_043']=stock.alpha043()
        df['alpha1_044']=stock.alpha044()
        df['alpha1_045']=stock.alpha045()
        df['alpha1_046']=stock.alpha046()
        df['alpha1_047']=stock.alpha047()
        df['alpha1_049']=stock.alpha049()
        df['alpha1_050']=stock.alpha050()
        df['alpha1_051']=stock.alpha051()
        df['alpha1_052']=stock.alpha052()
        df['alpha1_053']=stock.alpha053()
        df['alpha1_054']=stock.alpha054()
        df['alpha1_055']=stock.alpha055()
        df['alpha1_056']=stock.alpha056()
        df['alpha1_057']=stock.alpha057()
        df['alpha1_060']=stock.alpha060()
        df['alpha1_061']=stock.alpha061()
        df['alpha1_062']=stock.alpha062()
        df['alpha1_064']=stock.alpha064()
        df['alpha1_065']=stock.alpha065()
        df['alpha1_066']=stock.alpha066()
        df['alpha1_068']=stock.alpha068()
        df['alpha1_071']=stock.alpha071()
        df['alpha1_072']=stock.alpha072()
        df['alpha1_073']=stock.alpha073()
        df['alpha1_074']=stock.alpha074()
        df['alpha1_075']=stock.alpha075()
        df['alpha1_077']=stock.alpha077()
        df['alpha1_078']=stock.alpha078()
        df['alpha1_081']=stock.alpha081()
        df['alpha1_083']=stock.alpha083()
        df['alpha1_084']=stock.alpha084()
        df['alpha1_085']=stock.alpha085()
        df['alpha1_086']=stock.alpha086()
        df['alpha1_088']=stock.alpha088()
        df['alpha1_092']=stock.alpha092()
        df['alpha1_094']=stock.alpha094()
        df['alpha1_095']=stock.alpha095()
        df['alpha1_096']=stock.alpha096()
        df['alpha1_098']=stock.alpha098()
        df['alpha1_099']=stock.alpha099()
        df['alpha1_101']=stock.alpha101()  
        print("Alpha computed sucessful!")
        return df
...
#                             columns=self.close.columns)
    ...
    def alpha023(self):
        ...
        alpha.at[cond,'close'] = -1 * delta(self.high, 2)
        return alpha
    ...
    def alpha085(self):
        ...
        return correlation(ts_rank(((self.high + self.low) / 2), 4), ts_rank(self.volume, 10), 7)
    ...
    def alpha094(self):
        ...
        #return correlation(ts_rank(self.vwap,20), ts_rank(adv60, 4), 18)
...
if __name__ == '__main__':
    df = read_raw_data('../data/0721_300676_part.csv')
    get_alpha(df)
    df.to_excel('../data/alpha101_0721_300676.xls', index=None)
    #test_alpha(df)
    #df.to_excel('../../data/alpha101_test.xls')
